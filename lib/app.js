        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
            while (1) {
                switch (_context7.prev = _context7.next) {
                    ...
                    case 6:
                        _context7.next = 8;
                        return console.log('cron start!');

                    case 8:
                        _context7.next = 10;
                        return new _cron.CronJob('00 30 11 * * 1-5', _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
