                                    ...
                                    while (1) {
                                        switch (_context5.prev = _context5.next) {
                                            ...
                                            case 8:
                                                ...
                                                u.map(function () {
                                                    var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(version) {
                                                        var v;
